...
<head>
<meta charset="UTF-8">
<title>Generador de Factura - Calculo de ventas</title>
<script
...
<link
	href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T"
				...
				<div class="card">
					<div class="card-body p-0">
						...
						<div
                            ...
                            <p>Bienvenido:&nbsp;<span style="color:blue;font-weight:bold"> <%= session.getAttribute("nombreSesion") %></span>  <a href="Logout">Cerrar Sesion</a>
        </a></p>
						</div>
						<div
							style="margin: 0 auto; padding-left: 20px; padding-right: 20px;">
							<form action="intermedio" method="POST">
								<div class="row">
									<div class="col-sm">
